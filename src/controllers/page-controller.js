...
export default class PageController {
  ...
  renderFilms(filmsToRender) {
    ...
    const topRatedFilms = getTwoTopRates(this._movies.getMoviesAll());
  ...
  renderTopCommented() {
    ...
    const topCommentedMovies = getTwoTopCommented(this._movies.getMoviesAll());
