...
class Provider {
  ...
  getMovies() {
    if (this._isOnLine()) {
      ...
      return Promise.resolve(_models_movie__WEBPACK_IMPORTED_MODULE_0__["default"].parseMovies(items));
    }
  }
  ...
  updateMovie(id, data) {
    if (this._isOnLine()) {
      ...
      this._setStoreItem(id, data, _utils_util__WEBPACK_IMPORTED_MODULE_2__["MovieOfflineStatus"].UPDATED);
  ...
  getComments(id) {
    if (this._isOnLine()) {
      ...
      if (storeMovie) {
        return Promise.resolve(_models_comment__WEBPACK_IMPORTED_MODULE_1__["default"].parseComments(storeMovie.data.comments));
      }
    }
    return Promise.resolve(_models_comment__WEBPACK_IMPORTED_MODULE_1__["default"].parseComments([]));
  }

  _setStoreItem(key, data, state = _utils_util__WEBPACK_IMPORTED_MODULE_2__["MovieOfflineStatus"].INITIAL) {
  ...
  sync() {
    ...
    const items = Object.values(data).filter((dataItem) => {
      return dataItem.state === _utils_util__WEBPACK_IMPORTED_MODULE_2__["MovieOfflineStatus"].UPDATED;
    }).map((item) => {
      return item.data;
    });
    return this._api.sync(items).then((result) => {
      ...
      if (result && result.updated) {
        const updatedMovies = _models_movie__WEBPACK_IMPORTED_MODULE_0__["default"].parseMovies(result.updated);
...
class AbstractComponent {
  ...
  getElement() {
    if (!this._element) {
      this._element = Object(_utils_util__WEBPACK_IMPORTED_MODULE_0__["createElement"])(this.getTemplate());
    }
...
const addFilmCard = (card) => {
  ...
  return `<article class="film-card">
          ...
          <p class="film-card__info">
            ...
            <span class="film-card__duration">${Object(_utils_util__WEBPACK_IMPORTED_MODULE_0__["getFilmDuration"])(runTime)}</span>
            <span class="film-card__genre">${Object(_utils_util__WEBPACK_IMPORTED_MODULE_0__["generateGenres"])(genres)}</span>
          </p>
...
/*!****************************************!*\
  !*** ./src/components/film-details.js ***!
  \****************************************/
/*! exports provided: renderComments, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "renderComments", function() { return renderComments; });
...
const getCommentedDate = (date) => {
  ...
  const duration = moment__WEBPACK_IMPORTED_MODULE_2___default.a.duration(Number(dateNow) - date);

  if (duration.days() > 0) {
    return `a ${duration.days() === 1 ? `one day` : `${number_to_words__WEBPACK_IMPORTED_MODULE_3___default.a.toWords(duration.days())} days`} ago`;
...
const renderComments = (comments, online) => {
  return comments
    .map((el) => {
...
const addFilmDetails = (data, isInHistory, emojiImg, commentsArr, isInWatchList, isFavorite, personalRating, sendingObj, online) => {
  ...
  const getReleaseDate = () => moment__WEBPACK_IMPORTED_MODULE_2___default()(releaseDate).format(`DD MMMM YYYY`);
        ...
        <div class="film-details__info">
          ...
          <table class="film-details__table">
            ...
            <tr class="film-details__row">
              ...
              <td class="film-details__cell">${Object(_utils_util__WEBPACK_IMPORTED_MODULE_0__["getFilmDuration"])(runTime)}</td>
            </tr>
            <tr class="film-details__row">
            ...
            <tr class="film-details__row">
              ...
              <td class="film-details__cell">
                ${Object(_utils_util__WEBPACK_IMPORTED_MODULE_0__["generateGenres"])(genres)}
                </td>
            </tr>
          </table>
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FooterStat; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");
...
class FooterStat extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(number) {
    super();
    this._number = number;
  }
...
class MostCommented extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
const addNavigationBlock = (filters, activeFilter) => {
  const renderFilters = () => {
    return filters.map((el) => `<a href="#${el.title}" class="main-navigation__item ${activeFilter === el.title ? `main-navigation__item--active` : ``}">${Object(_utils_util__WEBPACK_IMPORTED_MODULE_0__["capitalizeFirstLetter"])(el.title)}<span class="main-navigation__item-count">${el.count}</span></a>`).join(`\n`);
  };
...
class Navigation extends _abstract_component__WEBPACK_IMPORTED_MODULE_1__["default"] {
...
/*!***********************************!*\
  !*** ./src/components/profile.js ***!
  \***********************************/
/*! exports provided: MovieThreshold, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MovieThreshold", function() { return MovieThreshold; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Profile; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");


const MovieThreshold = {
  BUFF: 21,
  FAN: 10,
  NOVICE: 0
};
...
const getWeekData = (data) => {
  const end = moment__WEBPACK_IMPORTED_MODULE_3___default()();
...
const renderChart = (data) => {
  ...
  const myChart = new chart_js__WEBPACK_IMPORTED_MODULE_1___default.a(ctx, {
...
const template = (data) => {
  ...
  const totalDuration = moment__WEBPACK_IMPORTED_MODULE_3___default.a.duration(data.reduce((acc, el) => acc + el.runTime, 0));
...
class Stat extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(model) {
    super();
    this._model = model;
...
class TopRated extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/* harmony import */ var _models_movie__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../models/movie */ "./src/models/movie.js");
...
class MovieController {
  ...
  setDefaultView() {
    if (this._mode !== Mode.DEFAULT) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._newFilmDetail);
  ...
  closePopUp(element) {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["remove"])(element);
  }
  ...
  render(movie) {
    ...
    this._newCard = new _components_film_card__WEBPACK_IMPORTED_MODULE_0__["default"](movie);

    const alreadyWatchedDebounce = lodash_debounce__WEBPACK_IMPORTED_MODULE_5___default()(() => {
      const watchedDateNow = this._newFilmDetail.getIsWatched() ? new Date() : this._movie.whatchedDate;
      const newMovie = _models_movie__WEBPACK_IMPORTED_MODULE_4__["default"].clone(movie);
    ...
    const addToWatchlistDebounced = lodash_debounce__WEBPACK_IMPORTED_MODULE_5___default()(() => {
    ...
    const addToFavoriteDebounce = lodash_debounce__WEBPACK_IMPORTED_MODULE_5___default()(() => {
      const newMovie = _models_movie__WEBPACK_IMPORTED_MODULE_4__["default"].clone(movie);
    ...
    const filmCardClickHandler = (el) => {
      return () => {
        ...
        this._api.getComments(this._movie.id)
          .then((comments) => {
            this._newFilmDetail = new _components_film_details__WEBPACK_IMPORTED_MODULE_2__["default"](el);
            ...
            Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(this._footerBlock, this._newFilmDetail.getElement(), _utils_util__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].AFTEREND);
    ...
    const movieCardAlreadyWatchedDebounce = lodash_debounce__WEBPACK_IMPORTED_MODULE_5___default()(() => {
    ...
    const movieCardAddToWatchlistDebounce = lodash_debounce__WEBPACK_IMPORTED_MODULE_5___default()(() => {
      const newMovie = _models_movie__WEBPACK_IMPORTED_MODULE_4__["default"].clone(movie);
    ...
    const movieAddToFavoritesDebounce = lodash_debounce__WEBPACK_IMPORTED_MODULE_5___default()(() => {
      const newMovie = _models_movie__WEBPACK_IMPORTED_MODULE_4__["default"].clone(movie);
    ...
    if (prevCard) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._newCard.getElement(), prevCard.getElement());
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._newCard.getElement());
    }
  }
...
/* harmony import */ var _utils_render__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/render */ "./src/utils/render.js");
/* harmony import */ var _utils_filters__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/filters */ "./src/utils/filters.js");
/* harmony import */ var _utils_util__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/util */ "./src/utils/util.js");
...
class NavigationController {
  constructor(container, model, pageController, stat) {
    ...
    this._activeFilter = _utils_util__WEBPACK_IMPORTED_MODULE_3__["FilterType"].ALL;
    this._onDataChange = () => {
      this.rerender();
    };
  ...
  render() {
    this._navigation = new _components_navigation__WEBPACK_IMPORTED_MODULE_0__["default"](Object(_utils_filters__WEBPACK_IMPORTED_MODULE_2__["generateFilters"])(this._model.getMoviesAll()), this._activeFilter);
    this._navigation.setFiltersClickHandler(this._onFilterChange);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._navigation.getElement());
  }

  rerender() {
    const newNavComp = new _components_navigation__WEBPACK_IMPORTED_MODULE_0__["default"](Object(_utils_filters__WEBPACK_IMPORTED_MODULE_2__["generateFilters"])(this._model.getMoviesAll()), this._activeFilter);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["replace"])(newNavComp.getElement(), this._navigation.getElement());
...
/* harmony import */ var _components_show_more_button__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/show-more-button */ "./src/components/show-more-button.js");
/* harmony import */ var _utils_render__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/render */ "./src/utils/render.js");
/* harmony import */ var _components_no_movies__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/no-movies */ "./src/components/no-movies.js");
/* harmony import */ var _components_top_rated__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/top-rated */ "./src/components/top-rated.js");
/* harmony import */ var _components_most_commented__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/most-commented */ "./src/components/most-commented.js");
/* harmony import */ var _components_films__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/films */ "./src/components/films.js");
...
/* harmony import */ var _movie_controller__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./movie-controller */ "./src/controllers/movie-controller.js");
/* harmony import */ var _navigation_controller__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./navigation-controller */ "./src/controllers/navigation-controller.js");
/* harmony import */ var _models_movie__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../models/movie */ "./src/models/movie.js");
/* harmony import */ var _models_comment__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../models/comment */ "./src/models/comment.js");
...
const renderMovies = (container, movies, onDataChange, onViewChange, api) => {
  return movies.map((movie) => {
    const movieController = new _movie_controller__WEBPACK_IMPORTED_MODULE_7__["default"](container, onDataChange, onViewChange, api);
...
class PageController {
  constructor(container, movies, stat, api) {
    this._api = api;
    this._container = container;
    this._showMoreButton = new _components_show_more_button__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this._films = new _components_films__WEBPACK_IMPORTED_MODULE_5__["default"]();
    this._sort = new _components_sort__WEBPACK_IMPORTED_MODULE_6__["default"]();
    this._stat = stat;
    this._moviesControllers = [];
    this._filmsToRender = [];
    this._navigation = null;
    this._mostCommented = null;
    this._sortedType = _components_sort__WEBPACK_IMPORTED_MODULE_6__["SortType"].DEFAULT;
    this._movies = movies;
    ...
    this._sortMovies = (sortType) => {
      ...
      switch (sortType) {
        case _components_sort__WEBPACK_IMPORTED_MODULE_6__["SortType"].DEFAULT:
          ...
          break;
        case _components_sort__WEBPACK_IMPORTED_MODULE_6__["SortType"].BY_DATE:
          this.renderFilms(sortedFilms.sort((a, b) => b.releaseDate - a.releaseDate));
          break;
        case _components_sort__WEBPACK_IMPORTED_MODULE_6__["SortType"].BY_RATING:
    ...
    this._showMoreButtonClickHandler = () => {
      ...
      if (this._showFilmsCount >= this._movies.getMovies().length) {
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._showMoreButton);
      }
    };
  ...
  _deleteComment(movieController, oldMovieData, newMovieData, filmDetail) {
    this._api.deleteComment(oldMovieData)
      .then(() => {
        const oldMovie = _models_movie__WEBPACK_IMPORTED_MODULE_9__["default"].clone(movieController.getMovieData());
  ...
  _createComment(movieController, oldMovieData, newMovieData, filmDetail) {
    this._api.createComment(oldMovieData.id, newMovieData).then((response) => {
      const newMovie = _models_movie__WEBPACK_IMPORTED_MODULE_9__["default"].parseMovie(response.movie);
      const newComments = _models_comment__WEBPACK_IMPORTED_MODULE_10__["default"].parseComments(response.comments);
  ...
  render() {
    this._navigation = new _navigation_controller__WEBPACK_IMPORTED_MODULE_8__["default"](this._container, this._movies, this, this._stat);
    this._showFilmsCount = NUMBER_OF_FILMS_ADD;

    this._navigation.render();
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._sort.getElement());
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._films.getElement());
    this._filmsListBlock = document.querySelector(`.films-list`);
    this._filmsContainer = document.querySelector(`.films-list__container`);
  ...
  renderFilms(filmsToRender) {
    ...
    if (filmsToRender.length === 0) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(this._filmsListBlock, new _components_no_movies__WEBPACK_IMPORTED_MODULE_2__["default"]().getElement());
    } else if (this._movies.getMovies().length > this._showFilmsCount) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(this._filmsListBlock, this._showMoreButton.getElement());
    ...
    if (topRatedFilms.length > 0 && topRatedFilms[0].filmMark !== 0) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(this._films.getElement(), new _components_top_rated__WEBPACK_IMPORTED_MODULE_3__["default"]().getElement());
  ...
  renderTopCommented() {
    ...
    if (this._mostCommented) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._mostCommented);
      this._mostCommented = null;
    }
    if (topCommentedMovies.length > 0 && topCommentedMovies[0].comments !== 0) {
      this._mostCommented = new _components_most_commented__WEBPACK_IMPORTED_MODULE_4__["default"]();
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(this._films.getElement(), this._mostCommented.getElement());
      const elFilmLists = document.querySelectorAll(`.films-list--extra .films-list__container`);
...
/* harmony import */ var _components_footer_stat__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/footer-stat */ "./src/components/footer-stat.js");
...
/* harmony import */ var _components_stat__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/stat */ "./src/components/stat.js");
/* harmony import */ var _api_index__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./api/index */ "./src/api/index.js");
/* harmony import */ var _api_store__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./api/store */ "./src/api/store.js");
...
const api = new _api_index__WEBPACK_IMPORTED_MODULE_6__["default"](END_POINT, AUTHORIZATION);
const store = new _api_store__WEBPACK_IMPORTED_MODULE_7__["default"](STORE_NAME, window.localStorage);
const apiWithProvider = new _api_provider__WEBPACK_IMPORTED_MODULE_8__["default"](api, store);
const movies = new _models_movies__WEBPACK_IMPORTED_MODULE_4__["default"]();
let stat = null;
let pageController = null;
const title = document.title;
const loading = new _components_loading__WEBPACK_IMPORTED_MODULE_9__["default"]();

Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(mainBlock, loading.getElement());

apiWithProvider.getMovies().then((moviesData) => {
  Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(loading);
  movies.setMovies(moviesData);
  stat = new _components_stat__WEBPACK_IMPORTED_MODULE_5__["default"](movies);
  pageController = new _controllers_page_controller__WEBPACK_IMPORTED_MODULE_3__["default"](mainBlock, movies, stat, apiWithProvider);
  pageController.render();
  Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(headerBlock, new _components_profile__WEBPACK_IMPORTED_MODULE_0__["default"](movies.getMovies().filter((el) => el.isInWatchList).length).getElement());
  Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(mainBlock, stat.getElement());
  Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(footerBlock, new _components_footer_stat__WEBPACK_IMPORTED_MODULE_1__["default"](movies.getMovies().length).getElement());
});
...
class Movies {
  constructor() {
    this._movies = [];
    this._activeFilterType = _utils_util__WEBPACK_IMPORTED_MODULE_0__["FilterType"].ALL;
  ...
  getMovieByFilter() {
    switch (this._activeFilterType) {
      case _utils_util__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FAVORITES:
        return this._movies.filter((el) => el.isFavorite);
      case _utils_util__WEBPACK_IMPORTED_MODULE_0__["FilterType"].HISTORY:
        return this._movies.filter((el) => el.isInHistory);
      case _utils_util__WEBPACK_IMPORTED_MODULE_0__["FilterType"].WHATCHLIST:
...
const render = (container, element, place = _util__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND) => {
  switch (place) {
    case _util__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND:
      container.append(element);
      break;
    case _util__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTEREND:
      container.insertAdjacentElement(_util__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTEREND, element);
      break;
  }
};
...
/*!***************************!*\
  !*** ./src/utils/util.js ***!
  \***************************/
/*! exports provided: MovieOfflineStatus, FilterType, RenderPosition, getFilmDuration, generateGenres, capitalizeFirstLetter, createElement */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MovieOfflineStatus", function() { return MovieOfflineStatus; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "generateGenres", function() { return generateGenres; });
...
const getFilmDuration = (runTime) => {
  const momentDuration = moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(runTime);
